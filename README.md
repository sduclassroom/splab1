...
Your solution should be stored in file [./solution/top10](./solution/top10). To run the solution make it executable by `chmod +x top10` command. Your solution typically will include 2-7 lines of commmands. A one liner solution is also possible but probably it will look ugly (my subjective point of view).
